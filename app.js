...
async function generateDocx() {
  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
        headerTable,
        para(run("Address: Kyiv, 03041, Dniprovska Naberezhna St. 7А, office 104.", { italics: true, underline: {}, size: 18 }), { alignment: AlignmentType.CENTER }),
        para(run("Tel. +38 067 2611682", { italics: true, underline: {}, size: 18 }), { alignment: AlignmentType.CENTER }),
        para([
        ...
        ], { alignment: AlignmentType.CENTER, border: { bottom: { style: BorderStyle.SINGLE, size: 8, color: "000000", space: 4 } } }),
        para(
